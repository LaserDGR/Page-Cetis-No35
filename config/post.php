...
if (isset($_POST['save_score'])){
    ...
    $query = "INSERT INTO calificaciones(n_control,nombre,parcial1,parcial2,parcial3,promedio,
    observacion, asigntura) VALUES ('$n_control','$nombre','$parcial1','$parcial2', '$parcial3',
    , '$promedio',, '$observacion', '$asignatura')";
